...
Faithful Flask port of the Next.js app at /home/z/my-project:
...
- Background scheduler: update_overdue_statuses hourly,
  send_due_soon_reminders daily — mirrors Next.js cron.
...
def _start_scheduler(app):
    ...
    Mirrors the Next.js scheduled jobs — keeps the DB consistent even
